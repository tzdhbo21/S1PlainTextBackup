...
##### 1#       楼主       发表于 2020-12-14 13:30
 ...
 本帖最后由 吴有人 于 2020-12-15 11:04 编辑 
...
（主程序）程序员小哥哥/小姐姐（这个大概率也是不会有小姐姐了<img src="https://static.saraba1st.com/image/smiley/face2017/053.png" referrerpolicy="no-referrer">）


需求

核心：热爱游戏，资深的单机游戏、主机游戏玩家（如果你steam库比我大就加10分！<img src="https://static.saraba1st.com/image/smiley/face2017/019.png" referrerpolicy="no-referrer">我现在大约700多个，不算工具软件DLC等）

1.需要一个能Hold住一个基于U3D平台的策略类单机游戏客户端的程序。未来会负责架构、UI、渲染、逻辑、还包括周边工具的一条龙，不需要样样精通，但需要至少了解并有一定技术能力。
2.需要有做游戏逻辑的经验，特别是NPC AI相关的实现经验。
3.需求有耐心，能忍受几年的持续迭代开发。
4.基于上个项目的经验，最好还有做过性能优化的经历。
<strong>（如果大佬对以上要求有异议，并且觉得自己有更好的方法也能实现文明那样的游戏，保证大后期不卡的，请无视上面的要求，具体操作方法，我们可以沟通，手段不重要，重要的是目的。）</strong>
